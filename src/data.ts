export default `mime,name,fileType
...
application/x-msdos-program,Microsoft Application,.exe
...
application/vnd.openxmlformats-officedocument.spreadsheetml.template,Microsoft Office - OOXML - Spreadsheet Template,.xltx
...
application/vnd.google-apps.audio,Google Audio,.vnd.google-apps.audio
application/vnd.google-apps.document,Google Docs,.google-apps.document
application/vnd.google-apps.drive-sdk,3rd party shortcut,.google-apps.drive-sdk
application/vnd.google-apps.drawing,Google Drawing,.google-apps.drawing
application/vnd.google-apps.file,Google Drive file,.google-apps.file
...
application/vnd.google-apps.script,Google Apps Scripts,.google-apps.script
application/vnd.google-apps.shortcut,Shortcut,.google-apps.shortcut
application/vnd.google-apps.site,Google Sites,.google-apps.site
application/vnd.google-apps.spreadsheet,Google Sheets,.google-apps.spreadsheet
